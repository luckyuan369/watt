	...
	<div class="wrap clearfix">
					...
					<form method="post" id="JS-project_add_form">
						...
						<div class="project-edit">
							<div class="form-item clearfix">
								<label>项目名称：</label>
								<input name="name" type="text" class="inp-w310" value="" maxlength="40" placeholder="名称不可超过40个字">
							</div>
							<div class="form-item clearfix">
								<label>筹集份数：</label>
								<input name="copies" type="text" value="" placeholder="不少于1份">
							</div>
							<div class="form-item clearfix">
								<label>每份金额：</label>
								<input name="limit_price" type="text" value="" placeholder="不少于1元">
							</div>
							<div class="form-item clearfix">
								<label>筹集天数：</label>
								<input name="deal_days" type="text" value="" placeholder="10~90天">
							</div>
							<div class="form-item clearfix">
								<label>产品类别：</label>
							...
							<div class="form-item clearfix">
								<label>项目简介：</label>
								<textarea style="width:60%;height:30px" name="brief" maxlength="75" placeholder="不超过75个字"></textarea>
							</div>
							<div class="form-item clearfix">
								<label>项目详情：</label>
							...
							<div class="action tr">
								<a type="submit" href="javascript:void(0);" id="Js-save" class="btn-base btn-red-h48 common-sprite">
		...
		<div class="sidebar fr">
			...
			<div class="block-list">
				<div class="list-item">
					<a class="image item-figure" href="javascript:void(0);" title=""><img id="image" width="225" height="216" src="images/empty_thumb.gif" alt=""> </a>
					<h3><a id="Js-name" href="javascript:;"></a></h3>
					<div class="item-caption">
							<span class="caption-title">
								目标：<span id="Js-days">天</span>&nbsp;&nbsp;&nbsp;
								<span id="Js-price">每份 ￥</span><br>
								<span id="Js-copies">筹集份数:</span>
							</span>
						</div>
				</div>
			</div>
