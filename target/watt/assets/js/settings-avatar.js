function upd_file1(obj, file_id, uid) {
	...
	$("input[name='" + file_id + "']")
			.bind(
					...
					function() {
						$(obj).hide();
						$(obj).parent().find(".fileuploading").removeClass(
								"hide");
						$(obj).parent().find(".fileuploading").removeClass(
								"show");
						...
						$
								.ajaxFileUpload({
									url : 'fileAvatarUpload.watt?id='+ uid,
									secureuri : false,
									...
									success : function(data, status) {
										...
										if (data.status == 1) {
											...
											document.getElementById("headeravatar").src = data.middle_url+ "?r=" + Math.random();
											location.reload();
										} else {
											wx.alert(data.info);
										}
