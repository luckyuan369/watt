...
<body>
	...
	<div class="container projects">
		<div class="row wtheader">
			...
			<div class="col-md-5 wtheaderright">
				<div class="col-md-4 wtheaderright">有害物质</div>
				<div class="col-md-4 wtheaderright">三聚氢胺</div>
				<div class="col-md-4 wtheaderright" style="border-right: 0px;">细菌含量</div>
			</div>
		</div>
		<div class="row wtrow">
